                                ...
                                <li>
                                    <a href="#">
                                        <div class="image-thumb">
                                            <img src="<?=base_url('public/assets/front/') ?>images/team-13.jpg" alt="">
                                        </div>
...
<!-- Load jQuery -->
<script type="text/javascript" src="<?=base_url('public/assets/front/') ?>js/library/jquery-1.11.0.min.js"></script>
<script type="text/javascript" src="<?=base_url('public/assets/front/') ?>js/library/bootstrap.min.js"></script>
<script type="text/javascript" src="<?=base_url('public/assets/front/') ?>js/library/jquery.owl.carousel.js"></script>
<script type="text/javascript" src="<?=base_url('public/assets/front/') ?>js/library/jquery.appear.min.js"></script>
<script type="text/javascript" src="<?=base_url('public/assets/front/') ?>js/library/perfect-scrollbar.min.js"></script>
<script type="text/javascript" src="<?=base_url('public/assets/front/') ?>js/library/jquery.easing.min.js"></script>
<script type="text/javascript" src="<?=base_url('public/assets/front/') ?>js/scripts.js"></script>
</body>
</html>