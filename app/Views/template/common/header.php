...
<head>
    ...
    <!-- Css -->
    <link rel="stylesheet" type="text/css" href="<?=base_url('public/assets/front/') ?>css/library/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url('public/assets/front/') ?>css/library/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url('public/assets/front/') ?>css/library/owl.carousel.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url('public/assets/front/') ?>css/md-font.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url('public/assets/front/') ?>css/style.css">
    <!--[if lt IE 9]>
...
<div id="page-wrap">
    ...
    <header id="header" class="header">
        <div class="container">
            ...
            <!-- LOGO -->
            <div class="logo"><a href="<?=base_url();?>"><img src="<?=base_url('public/assets/front/') ?>images/logo.png" alt=""></a></div>
            <!-- END / LOGO -->
                                ...
                                <li class="ac-new">
                                    <a href="#">
                                        <div class="list-body">
                                            ...
                                            <div class="image">
                                                <img src="<?=base_url('public/assets/front/') ?>images/feature/img-1.jpg" alt="">
                                            </div>
                                            <div class="time">
