    ...
    <!-- HOME SLIDER -->
    <section class="slide" style="background-image: url(<?=base_url('public/assets/front/') ?>images/homeslider/bg.jpg)">
        <div class="container">
            <div class="slide-cn" id="slide-home">
                ...
                <div class="slide-item">
                    <div class="item-inner">
                        ...
                        <div class="img">
                            <img src="<?=base_url('public/assets/front/') ?>images/homeslider/img-thumb.png" alt="">
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="section-2-content">
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="image">
                            <img src="<?=base_url('public/assets/front/') ?>images/image.png" alt="">
                        </div>
                    </div>
                        ...
                        <div class="mc-item mc-item-1">
                            ...
                            <div class="content-item">
                                <div class="image-author">
                                    <img src="<?=base_url('public/assets/front/') ?>images/avatar-1.jpg" alt="">
                                </div>
